	...
	@autoreleasepool 
	{
        ...
        if ([ASIdentifierManager instancesRespondToSelector:@selector(advertisingIdentifier )]) {
            ...
            if (self.locationAwareAdverts && self.currentLatitude && self.currentLongitude) {
                ...
                requestString=[NSString stringWithFormat:@"c.mraid=%@&o_iosadvidlimit=%@&u=%@&v=%@&s=%@&iphone_osversion=%@&o_iosadvid=%@&rt=%@&t=%@&i=%@&lon=%@&lat=%@",
                ...
                requestString=[NSString stringWithFormat:@"c.mraid=%@&o_iosadvidlimit=%@&u=%@&v=%@&s=%@&iphone_osversion=%@&o_iosadvid=%@&rt=%@&t=%@&i=%@",
                               [mRaidCapable stringByUrlEncoding],
                               [o_iosadvidlimit stringByUrlEncoding],
                               [self.userAgent stringByUrlEncoding],
                               [SDK_VERSION stringByUrlEncoding],
            ...
            if (self.locationAwareAdverts && self.currentLatitude && self.currentLongitude) {
                ...
                requestString=[NSString stringWithFormat:@"c.mraid=%@&u=%@&v=%@&s=%@&iphone_osversion=%@&rt=%@&t=%@&i=%@&lon=%@&lat=%@",
                               [mRaidCapable stringByUrlEncoding],
                               [self.userAgent stringByUrlEncoding],
                               [SDK_VERSION stringByUrlEncoding],
                               [publisherId stringByUrlEncoding],
                ...
                requestString=[NSString stringWithFormat:@"c.mraid=%@&u=%@&v=%@&s=%@&iphone_osversion=%@&rt=%@&t=%@&i=%@",
                               [mRaidCapable stringByUrlEncoding],
                               [self.userAgent stringByUrlEncoding],
                               [SDK_VERSION stringByUrlEncoding],
                               [publisherId stringByUrlEncoding],
