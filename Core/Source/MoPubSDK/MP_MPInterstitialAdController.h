...
@interface MP_MPInterstitialAdController : UIViewController <MPAdViewDelegate, MPBaseInterstitialAdapterDelegate>
{
	...
	MP_MPInterstitialAdView *_adView;
 ...
 */
- (void)interstitialDidLoadAd:(MP_MPInterstitialAdController *)interstitial;
- (void)interstitialDidFailToLoadAd:(MP_MPInterstitialAdController *)interstitial;
 ...
 */
- (void)interstitialWillAppear:(MP_MPInterstitialAdController *)interstitial;
- (void)interstitialDidAppear:(MP_MPInterstitialAdController *)interstitial;
- (void)interstitialWillDisappear:(MP_MPInterstitialAdController *)interstitial;
- (void)interstitialDidDisappear:(MP_MPInterstitialAdController *)interstitial;
 ...
 * new ad, if desired.
 */
- (void)interstitialDidExpire:(MP_MPInterstitialAdController *)interstitial;
 ...
 */
- (void)dismissInterstitial:(MP_MPInterstitialAdController *)interstitial MOPUB_DEPRECATED;
...
- (void)adViewDidFailToLoadAd:(MP_MPAdView *)view MOPUB_DEPRECATED;
- (void)adViewDidLoadAd:(MP_MPAdView *)view MOPUB_DEPRECATED;
- (void)willPresentModalViewForAd:(MP_MPAdView *)view MOPUB_DEPRECATED;
- (void)didDismissModalViewForAd:(MP_MPAdView *)view MOPUB_DEPRECATED;
- (void)adView:(MP_MPAdView *)view didReceiveResponseParams:(NSDictionary *)params MOPUB_DEPRECATED;
- (void)adViewShouldClose:(MP_MPAdView *)view MOPUB_DEPRECATED;
