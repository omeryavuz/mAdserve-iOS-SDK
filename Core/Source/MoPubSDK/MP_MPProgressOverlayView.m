...
@implementation MP_MPProgressOverlayView
                      ...
                      delegate:(id<MPProgressOverlayViewDelegate>)delegate
{
    ...
    MP_MPProgressOverlayView *overlay = [[MP_MPProgressOverlayView alloc] initWithFrame:window.bounds];
...
{
    MP_MPProgressOverlayView *overlay = [self overlayForWindow:window];
...
+ (MP_MPProgressOverlayView *)overlayForWindow:(UIWindow *)window
{
    ...
    for (UIView *view in subviews) {
        if ([view isKindOfClass:[MP_MPProgressOverlayView class]]) {
            return (MP_MPProgressOverlayView *)view;
        }
    }
    return nil;
}
