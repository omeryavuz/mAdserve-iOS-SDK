...
@implementation MR_MRCloseCommand

+ (void)load {
    [MR_MRCommand registerCommand:self];
}
...
@implementation MR_MRExpandCommand
...
@implementation MR_MRUseCustomCloseCommand
...
@implementation MR_MROpenCommand
