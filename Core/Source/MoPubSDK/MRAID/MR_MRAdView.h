...
@class MR_MRAdViewBrowsingController, MR_MRAdViewDisplayController, MR_MRProperty;
...
@interface MR_MRAdView : UIView <UIWebViewDelegate> {
    ...
    MR_MRAdViewBrowsingController *_browsingController;
    
    // Performs display-related actions, such as expanding and closing the ad.
    MR_MRAdViewDisplayController *_displayController;
...
- (void)adWillShow:(MR_MRAdView *)adView;

// Called just after the ad has been displayed on-screen.
- (void)adDidShow:(MR_MRAdView *)adView;

// Called just before the ad is hidden.
- (void)adWillHide:(MR_MRAdView *)adView;

// Called just after the ad has been hidden.
- (void)adDidHide:(MR_MRAdView *)adView;

// Called just before the ad expands.
- (void)willExpandAd:(MR_MRAdView *)adView
			 toFrame:(CGRect)frame;

// Called just after the ad has expanded.
- (void)didExpandAd:(MR_MRAdView *)adView
			toFrame:(CGRect)frame;
