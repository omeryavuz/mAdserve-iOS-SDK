...
@property (nonatomic, strong) MP_MPMraidAdapter *adapter;
...
- (void)setupAdFromXml:(DTXMLDocument *)xml
{
    ...
    else if ([adType isEqualToString:@"mraidAd"])
	{
        ...
        self.adapter = [[MP_MPMraidAdapter alloc] initWithAdapterDelegate:self];
        ...
        NSDictionary *params = [NSDictionary dictionaryWithObjectsAndKeys:
                                ...
                                _data, @"payload",
                                nil];
        [self.adapter getAdWithParams:params];
...
- (void)asyncRequestAdWithPublisherId:(NSString *)publisherId
{
	@autoreleasepool 
	{
        ...
        if ([ASIdentifierManager instancesRespondToSelector:@selector(advertisingIdentifier )]) {
            ...
            requestString=[NSString stringWithFormat:@"c.mraid=%@&o_iosadvidlimit=%@&rt=%@&u=%@&o_iosadvid=%@&v=%@&s=%@&iphone_osversion=%@&spot_id=%@",
           ...
           requestString=[NSString stringWithFormat:@"c.mraid=%@&rt=%@&u=%@&v=%@&s=%@&iphone_osversion=%@&spot_id=%@",
                           [mRaidCapable stringByUrlEncoding],
                           [requestType stringByUrlEncoding],
                           [self.userAgent stringByUrlEncoding],
                           [SDK_VERSION stringByUrlEncoding],
